...
%myerrorbar.m
%
%    usage: initially myerrorbar(x,y,varargin)  SLerrorbar
%       by: justin gardner modified by steeve laquitaine
%     date: 06/24/07 last modification 140508
...
%           tee=draw tees or not,default 0ed
...
%Plot errorbars
function [h,retval] = SLerrorbar(x,y,varargin)
...
%plot the symbols
h = plot(x,y,Symbol,'MarkerFaceColor',MarkerFaceColor,'MarkerEdgeColor',...
    MarkerEdgeColor,'Linestyle',Linestyle,'Color',Color,...
