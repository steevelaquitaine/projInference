...
%         task = SLinitRunExpUniPrior('steeve_exp12_metho_Pstd010_mean225_coh006012024_dir36_t107_074_033perCoh_131224',225,33.336,[.06 .12 .24],[107 74 40],5:10:355,[.75 .75 0])
%         task = SLinitRunExpUniPrior('steeve_exp12_metho_Pstd020_mean225_coh006012024_dir36_t103_074_029perCoh_131224',225,8.748,[.06 .12 .24],[103 74 29],5:10:355,[1 .2 0])
%         task = SLinitRunExpUniPrior('steeve_exp12_metho_Pstd040_mean225_coh006012024_dir36_t100_075_032perCoh_131224',225,2.7714,[.06 .12 .24],[100 75 32],5:10:355,[1 .6 0])
%         task = SLinitRunExpUniPrior('steeve_exp12_metho_Pstd080_mean225_coh006012024_dir36_t100_075_034perCoh_131224',225,0.74848,[.06 .12 .24],[110 74 40],5:10:355,[0.5 0 0])
%
%Description:
%
...
function task = SLinitRunExpUniPrior(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
...
subplot(3,2,1);
circHist(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(1,:),colorH,5)
subplot(3,2,3);
circHist(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(2,:),colorH,5)
subplot(3,2,5);
circHist(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(3,:),colorH,5)

%Draw distributions as histograms (coh)
subplot(3,2,2);
drawhistdir(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(1,:),fig,colorH);
text(0.9*max(task.parameter.dir.sample.degree),.90*max(task.parameter.dir.countperCoh(1,:)),'coh 6%','fontsize',14)
subplot(3,2,4);
drawhistdir(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(2,:),fig,colorH);
text(0.9*max(task.parameter.dir.sample.degree),.90*max(task.parameter.dir.countperCoh(2,:)),'coh 12%','fontsize',14)
subplot(3,2,6);
drawhistdir(task.parameter.dir.sample.degree,task.parameter.dir.countperCoh(3,:),fig,colorH);
text(0.9*max(task.parameter.dir.sample.degree),.90*max(task.parameter.dir.countperCoh(3,:)),'coh 24%','fontsize',14)
