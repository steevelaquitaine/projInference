...
%fixation parameters
fixStimulus.fixRadius = myscreen.fixRadius;
fixStimulus.thisColor = myscreen.fixationColor;
fixStimulus.pos = [myscreen.fixPosX myscreen.fixPosY];
...
mglGluDisk(myscreen.fixPosX,myscreen.fixPosY,myscreen.fixRadius,myscreen.fixationColor,24,2)