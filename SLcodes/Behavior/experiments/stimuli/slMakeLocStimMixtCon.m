...
% usage:
%
%       slMakeLocStimMixtCon('displayName=full','sigmaw=10')
%       slMakeLocStimMixtCon('displayName=Test','sigmaw=30')
%
%Description:
%           
%       contrasted wedge location stimulus such that within wedge area
...
function myscreen = slMakeLocStimMixtCon(varargin)
