...
%
%       hi-pass
%       slMakeLocStimWdgAreaBgFlash('displayName=Test','sigmaw=30','loadPrecompStim'); 
%       slMakeLocStimWdgAreaBgFlash('displayName=full','sigmaw=30','loadPrecompStim');
%
%       lo-pass
%       slMakeLocStimWdgAreaBgFlash('displayName=test','sigmaw=2')
%
%
%Options:
%
%   'loadPrecompStim': load precomputed stimulus from file
%                      'stim_slMakeLocStimWdgAreaBgFlash.mat'
%
%Description:
%
%       My favorite so far:
...
function myscreen = slMakeLocStimWdgAreaBgFlash(varargin)
