...
% usage:
%
%       slMakeLocStim('displayName=Test','sigmaw=10')
%
%
%Description:
%           
...
function myscreen = slMakeLocStim(varargin)
...
params.task.parameter.loc.con   = repmat([0.1 0.05 0.02],36,1);%repmat([0.0009 0.0018 0.0036],36,1);
...
%in the gamma table
gammaPoss = gammaTableNew(stimulus.colors.minStimIx:end,:);
