...
%
%           slTaskLocEst('fMRI')
%           slTaskLocEst('psychophysics','displayName=Test','responseObject=dot','responseDevice=0')
...
function myscreen = slTaskLocEst(varargin)
...
elseif task.thistrial.trialType == 0
    ...
    if (task.thistrial.thisseg == 5)
        ...
        elseif strcmp(myscreen.responseObject,'dot');
            mglPoints2(feedbackcoord.x.angle.onap,feedbackcoord.y.angle.onap,8,stimulus.colors.resvdNormIx(1))
        end
    end      
end
