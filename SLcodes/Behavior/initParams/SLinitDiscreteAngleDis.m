...
%SLinitDiscreteAngleDis.m
%
% author: steeve laquitaine
%   date: 160111
%purpose: Generate time series of angles from symetric discrete 
...
%
%
%         task = SLinitDiscreteAngleDis('paramsPrior1',225,33.336,[1 0.12 0.1],[107 74 40],5:10:355,[.75 .75 0])
%
%
%inputs:
%            Prname: .mat file name of saved parameters. File is saved in the
%                    same path as the function 
%                    e.g., 'paramsPrior1'
%            Prmean: mean of discrete von Mises distribution in degrees
%                    e.g., 225
%             Prstd: von Mises concentration parameter (proportional to std)
%                    e.g., 33.3 (about 10 degrees std)
%               con: 3 contrast or coherence values
%                    e.g., [1 0.12 0.1]
%Prnumtrials_perCon: number of trials per contrast(or coherence, approximatif) 
%                    e.g., [107 74 40]
%              PrSp: circular discrete angle space on which von Mises is defined
%                    e.g., 5:10:355
%            colorH: color of von Mises histogram plot
%                    e.g., [.75 .75 0]
%
%
%Description:
%
% - at least 5 samples min of each direction (full range of sample angles).
%
% - symmetric distribution by discretization of a continuous dist (instead 
%   random of sampling which produce assymetry)
%
% - I used 4 discrete von Mises distribution concentrations parameters
...
%e.g.,
%         task = SLinitDiscreteAngleDis('paramsPrior1',225,33.336,[1 0.12 0.1],[107 74 40],5:10:355,[.75 .75 0])
%         task = SLinitDiscreteAngleDis('paramsPrior2',225,8.748,[1 0.12 0.1],[103 74 29],5:10:355,[1 .2 0])
%         task = SLinitDiscreteAngleDis('paramsPrior3',225,2.7714,[1 0.12 0.1],[100 75 32],5:10:355,[1 .6 0])
%         task = SLinitDiscreteAngleDis('paramsPrior4',225,0.74848,[1 0.12 0.1],[110 74 40],5:10:355,[0.5 0 0])
%
%a run
function task = SLinitDiscreteAngleDis(Prname,Prmean,Prstd,con,Prnumtrials_perCon,PrSp,colorH)
