...
%     date: 160425
%  purpose: organize circular data to permit plots of a circular 
%           dependent variable against 3 independent variables 
%           from the database
%   usage :
%
%e.g., 
...
%     %init factors in a 3D matrix
%     [fa,estimates] = slInitFAs(d,{'StimStrength','Pstd','FeatureSample'})
%
%
%Inputs:
%
%     d : a databank matrix produced by SLMakedatabank
%   FAs : {'StimStrength','Pstd','FeatureSample'} in any order
%
%Outputs:
%
%          FA: informations about the variables in the database
%   estimates: dependent circular variable organized in a 3D matrix (1 
%              dimension by variable)
