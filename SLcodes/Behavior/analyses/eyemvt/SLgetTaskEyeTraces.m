...
%
%        $Id:$ 
%      usage: e = SLgetTaskEyeTraces(stimfileName,varnameIn,<taskNum=1>,<phaseNum=1>,<dispFig=0>,<dataPad=3>,<removeBlink=1>)
%         by: justin gardner modified by Steeve Laquitaine
%       date: 06/23/10
...
%             e = getTaskEyeTraces(('101203_stim03','dir','removeBlink=0.1');
%             To remove say 5 samples from either side of the blink
%             e = getTaskEyeTraces(('101203_stim03','dir','removeBlink=5');
%
%             % if you want to display a figure with the eye positon
%             e = getTaskEyeTraces(('101203_stim03','dir','dispFig=1');
%
%             To get the eye traces relative to a segment other than 1
%             set the alternative field segNum equal to that segment
%             e = getTaskEyeTraces('100616_stim01','dir','segNum=2');
%
%    e = getTaskEyeTraces('100616_stim01','dir','taskNum=1','phaseNum=1','dataPad=3');
%
function e = SLgetTaskEyeTraces(stimfileName,varnameIn,varargin)
...
if exist('getArgs') == 2
  getArgs(varargin,{'taskNum=1','phaseNum=1','dispFig=0','dataPad=3','removeBlink=0','segNum=1','EdfRenamed'});
else
...
% display figure
if dispFig
  displayEyeTraces(e,varnameIn);
end

%%%%%%%%%%%%%%%%%%%%%%%%%%
%    displayEyeTraces    %
%%%%%%%%%%%%%%%%%%%%%%%%%%
function displayEyeTraces(e,varnameIn)
...
[stimvol names trialNums] = getStimvolFromVarname(varnameIn,e.stimfile.myscreen,e.stimfile.task,e.stimfile.taskNum,e.stimfile.phaseNum);
