...
% slSimulateBayesianModelWithData.m
%
...
% 
% slSimulateBayesianModelWithData({'sub01'},...
%     [10.74 4.77 1.74 1.74 4.77 10.74 34.25 0 0.001 15],...
%     'experiment','vonMisesPrior',...
%     'MAPReadout');
%
% [pred,coh,pstd,d,priorModes,simP,negElogL,negSumlogL]=slSimulateBayesianModelWithData({'sub03'},...
%     [80 40 3 30 30 30 30 0 0.001 15],...
%     'dataPath',pathLab,...
%     'experiment','bimodalPrior');
%
% [pred,coh,pstd,d,priorModes,simP,negElogL,negSumlogL]=slSimulateBayesianModelWithData({'sub01'},...
...
function [pred,coh,pstd,d,priorModes,simP,negElogL,negSumlogL] = slSimulateBayesianModelWithData(subjects,simP,varargin)

%help
if ieNotDefined('subjects')
    help SLsimulateBayesianModel
    return
end
...
if sum(strcmp(varargin,'dataPath'))
    ...
    fprintf('%s \n','(SLsimulateBayesianModel) You need to set dataPath')
    return
end

%data
fprintf('%s \n','(SLsimulateBayesianModel) Now creating a databank...')
...
if sum(strcmp(varargin,'MAPReadout'))==1
    ...
    [~,likeMAP11]=SLGirshickBayesLookupTable(ulall,motdir,kl1,modesPrior1,klearnt1,kcardinal,0,priorShape,TheModel,varargin);
    [~,likeMAP12]=SLGirshickBayesLookupTable(ulall,motdir,kl1,modesPrior2,klearnt2,kcardinal,0,priorShape,TheModel,varargin);
    [~,likeMAP13]=SLGirshickBayesLookupTable(ulall,motdir,kl1,modesPrior3,klearnt3,kcardinal,0,priorShape,TheModel,varargin);
    [~,likeMAP14]=SLGirshickBayesLookupTable(ulall,motdir,kl1,modesPrior4,klearnt4,kcardinal,0,priorShape,TheModel,varargin);
        
    %get likelihood of data in condition with coherence 12
    [~,likeMAP21]=SLGirshickBayesLookupTable(ulall,motdir,kl2,modesPrior1,klearnt1,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP22]=SLGirshickBayesLookupTable(ulall,motdir,kl2,modesPrior2,klearnt2,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP23]=SLGirshickBayesLookupTable(ulall,motdir,kl2,modesPrior3,klearnt3,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP24]=SLGirshickBayesLookupTable(ulall,motdir,kl2,modesPrior4,klearnt4,0,kcardinal,priorShape,TheModel,varargin);
    
    %get likelihood of data in condition with coherence 6
    [~,likeMAP31]=SLGirshickBayesLookupTable(ulall,motdir,kl3,modesPrior1,klearnt1,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP32]=SLGirshickBayesLookupTable(ulall,motdir,kl3,modesPrior2,klearnt2,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP33]=SLGirshickBayesLookupTable(ulall,motdir,kl3,modesPrior3,klearnt3,0,kcardinal,priorShape,TheModel,varargin);
    [MAP,likeMAP34]=SLGirshickBayesLookupTable(ulall,motdir,kl3,modesPrior4,klearnt4,0,kcardinal,priorShape,TheModel,varargin);
end
...
if sum(strcmp(varargin,'SamplingReadout'))==1
    ...
    %get likelihood of data in condition with coherence 24
    [~,likeMAP11]=SLBayesSamplingLookupTable(ulall,motdir,kl1,modesPrior1,klearnt1,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP12]=SLBayesSamplingLookupTable(ulall,motdir,kl1,modesPrior2,klearnt2,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP13]=SLBayesSamplingLookupTable(ulall,motdir,kl1,modesPrior3,klearnt3,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP14]=SLBayesSamplingLookupTable(ulall,motdir,kl1,modesPrior4,klearnt4,0,kcardinal,priorShape,TheModel,varargin);
    
    %get likelihood of data in condition with coherence 12
    [~,likeMAP21]=SLBayesSamplingLookupTable(ulall,motdir,kl2,modesPrior1,klearnt1,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP22]=SLBayesSamplingLookupTable(ulall,motdir,kl2,modesPrior2,klearnt2,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP23]=SLBayesSamplingLookupTable(ulall,motdir,kl2,modesPrior3,klearnt3,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP24]=SLBayesSamplingLookupTable(ulall,motdir,kl2,modesPrior4,klearnt4,0,kcardinal,priorShape,TheModel,varargin);
    
    %get likelihood of data in condition with coherence 6
    [~,likeMAP31]=SLBayesSamplingLookupTable(ulall,motdir,kl3,modesPrior1,klearnt1,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP32]=SLBayesSamplingLookupTable(ulall,motdir,kl3,modesPrior2,klearnt2,0,kcardinal,priorShape,TheModel,varargin);
    [~,likeMAP33]=SLBayesSamplingLookupTable(ulall,motdir,kl3,modesPrior3,klearnt3,0,kcardinal,priorShape,TheModel,varargin);
    [MAP,likeMAP34]=SLBayesSamplingLookupTable(ulall,motdir,kl3,modesPrior4,klearnt4,0,kcardinal,priorShape,TheModel,varargin);
end
...
if sum(strcmp(varargin,'modelTheoreticalPredictions'))==1
    ...
    fprintf('%.2f   %.2f   %.2f   %.2f   %.2f   %.2f   %.2f   %.2f   %.2f   %.05f   %.2f \n',...
        negElogL,kl1,kl2,kl3,klearnt1,klearnt2,klearnt3,klearnt4,kcardinal,Prandom,km)
