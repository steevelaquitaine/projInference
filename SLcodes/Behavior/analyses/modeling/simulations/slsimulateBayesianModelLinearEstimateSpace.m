% slsimulateBayesianModelLinearEstimateSpace.m
%
...
%
%
%       [po,MAP] = slsimulateBayesianModelLinearEstimateSpace(5:20:360,5:10:360,30,225,30,0,'vonMisesPrior','withoutCardinal');
%
%
%
%input: 
...
function [po,MAP] = slsimulateBayesianModelLinearEstimateSpace(ulall,...
    motdir,...
    kl,...
    modePrior,...
    klearnt,...
...
if strcmp(TheModel,'withCardinal')  && ~isnan(kcardinal)
    PRIORcardinal = slmakeGaussianPdfs(diSpace,[90 180 270 360],kcardinal,'norm');
...
if strcmp(priorShape,'vonMisesPrior')    
    PRIORlearnt = slmakeGaussianPdfs(diSpace,modePrior,klearnt,'norm');
