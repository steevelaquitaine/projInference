...
%   date: 150710 last modfi 150729
%purpose: fit WJM model to motion direction estimation data
%
%  usage:
%    
%     o = SLwjmPrefitInitp({'sub01'},[2 2 2 2.3 2.3 2.3 2.3 1 3],'experiment','vonMisesPrior') 
%
%    
%
...
%      - duration 16 hours  (10 cores, 103 iter, 289 funEval, 5000 trials,
%      328 dots): estimation 6 days with 1000 iter

function o = SLwjmPrefitInitp(subjects,initp,varargin)
...
[fitP,neglogl,exitflag,outputfit] = fminsearch(@(fitP) SLgetLogL_WJM(data,sCirad,cCi,kappaCi,kappa_sCi,prand,km,fitP,posC,count),...
    initp,options);
tocs1 = toc;
...
function [negloglAll,fitP,PestGivModel] = SLgetLogL_WJM(data,s,c,kappa,kappa_s,prand,km,fp,posC,count)
