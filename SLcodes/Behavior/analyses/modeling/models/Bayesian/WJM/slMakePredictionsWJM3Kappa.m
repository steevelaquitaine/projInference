...
%  usage: 
%
%      [Pdata,pPred,Bins,o] = slMakePredictionsWJM3Kappa({'sub01'},[40 5 5 2.77 4.5 15 300 1e-2 16],'experiment','vonMisesPrior')
%	   [Pdata,pPred,Bins,o] = slMakePredictionsWJM3Kappa({'sub02'},[0.5 0.5 0.5 100000 100000 1e6 1e6 0.01 15],'experiment','vonMisesPrior')
%      
%notes:
...
%   strength kappa different coherence produce different estimates density.
...
function [Pdata,pPred,Bins,o] = slMakePredictionsWJM3Kappa(subjects,simp,varargin)
...
%--------------------
tic
[logl,~,PestGivModel] = SLgetLogL_WJMrotatedDirHTP(data,s,cu,kappa,kappa_s,prand,km,simp,o.posC,o.uniqCond);
o.duration = toc;
o.logl 	   = logl;
