%SLgetLogL_WJMrotatedDirTest5.m
%
%
...
%  usage: 
%
%       [loglAll,fitP,Pest] = SLgetLogL_WJMrotatedDirTest5(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
%
%
% outputs:
%
...
%get logl of data
function [loglAll,fitP,Pest] = SLgetLogL_WJMrotatedDirTest5(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
...
parfor i = 1 : Nsu
    ...
    like_per_dot = taili + ampi*exp(kappa*cos(double(x)-svec3D)-kappa);
