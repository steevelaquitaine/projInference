...
%  usage:
%    
%    o = SLfitBayesianModel_WJM3({'sub01'},'experiment','vonMisesPrior')
%    
%   Visualize kappa strength
%
%           figure('color','w'); SLcircHist(1:1:360,round(vmPdfs(1:1:360,180,500,'norm')*1000),[1 0 0],10)
%
%note: 
% - matlabpool 10
% - fit duration per set of fit parameter : 25 min
% - estimated duration for 1000 sets of fit params : 416 hours (17 days)


function o = SLfitBayesianModel_WJM3(subjects,varargin)
...
%---------------------------------------------------------------
%Grid search of best initial model parameters for the 202 
...
%--------------------------------------------------------------
i = 0;
for kappa24 = 0%:10:90; %18 deg to 2 deg.
    for kappa12 = 0%:10:90; %18 deg to 2 deg.
        for kappa06 = 0%:10:90; %flat to 6 deg. 
            
            i = i + 1;      
            fitKappa(i,:) = [kappa24 kappa12 kappa06];
...
parfor i = 1 : nGrid
    ...
    fitp = [fitKappa(i,:) 0.748 2.77 8.7 33.3 1e-6 3e30];
