%SLgetLogL_WJMrotatedDirTest0.m
%
%
...
%  usage: 
%
%       [loglAll,fitP,Pest] = SLgetLogL_WJMrotatedDirTest0(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
%
%
% outputs:
%
...
%get logl of data
function [loglAll,fitP,Pest] = SLgetLogL_WJMrotatedDirTest0(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
