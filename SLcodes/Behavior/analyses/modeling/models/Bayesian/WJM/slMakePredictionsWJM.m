...
%  usage: 
%
%      [Pdata,pPred,Bins,o] = slMakePredictionsWJM({'sub01'}, [2.99 0.7 2.7 7.99 34.6 0.01 32.07],'experiment','vonMisesPrior')
%      [Pdata,pPred,Bins,o] = slMakePredictionsWJM({'sub01'}, [80 6 0.5 0.5 0.5 0.01 32.07],'experiment','vonMisesPrior')
%
%
%
%Description:
...
function [Pdata,pPred,Bins,o] = slMakePredictionsWJM(subjects,simp,varargin)
...
%data densities (36 bins by 202 conditions)
dataBins       = 0:10:360; 
