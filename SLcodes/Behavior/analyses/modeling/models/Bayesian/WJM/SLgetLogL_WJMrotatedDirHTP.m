...
%  usage:
%
%       [loglAll,fitP,Pest] = SLgetLogL_WJMrotatedDirHTP(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
%
%
% outputs:
%
...
%get logl of data
function [neglogl,fitP,Pest] = SLgetLogL_WJMrotatedDirHTP(data,s,c,kappa,kappa_s,prand,km,fp,posC,Cond)
