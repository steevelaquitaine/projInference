...
%slAnalysisLearningBarBootSlopesEarlyVsLate.m
%
%
...
%     [linfit_early,linfit_late,anov2_early,anov2_late] = slAnalysisLearningBarBootSlopesEarlyVsLate(d,100,1000,'bootstrapSlopeAndIntercept')
%
%
%Inputs:
%
...
function [linfit_early,linfit_late,anov2_early,anov2_late] = slAnalysisLearningBarBootSlopesEarlyVsLate(d,per,nboot,varargin)
