% slGetInstances.m
%
%        $Id: slGetInstances.m,v 1.5 2008/10/23 01:52:48 justin Exp $ 
%      usage: rois = slGetInstances(v,rois,stimvol,<startLag>,<blockLen>,<type>)
%         by: justin gardner
%       date: 09/29/08
...
function rois = slGetInstances(v,rois,stimvol,varargin)
