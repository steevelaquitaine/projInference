...
%slfMRIwrapperDisVoxSelbalDirVMfitfminS.m
%
%
...
%         distributions between switching conditions. Tuning parameters
%         searched with fminsearch Nelder mead
%
%   usage :
%
%       %e.g.,: 
...
%           [voxTuning,d,o] = slfMRIwrapperDisVoxSelbalDirVMfitfminS(o,'vmfit','significantTuning',[varargin,'fminsearch']);
%
%
%        %e.g.,: 
%
...
%           o.dataPath='/Users/steeve_laquitaine/Dropbox'; 
%           cd(o.dataPath); 
%           load d.mat
%
%           %plot voxel selectivity distribution
%           [voxTuning,d,o] = slfMRIwrapperDisVoxSelbalDirVMfitfminS(o,'vmfit','significantTuning',[varargin,'db',d,'fminsearch']);
% 
%
% inputs :
%
...
function  [voxTuning,d,o] = slfMRIwrapperDisVoxSelbalDirVMfitfminS(o,tuningType,tuningSignif,varargin)
