...
%slsimVoxTuningForRandResponses.m
%
%
% author : steeve laquitaine
%   date : 160510
%purpose : simulate Voxel tuning to motion directions when voxels responses
%          to motion are random.
%          Conditions are : 5 motion directions, 2 switching conditions and
%          2 coherences. Voxel tuning are plotted for one coherence; 
%          sorted by switching
%
%    usage:
%
%           slsimVoxTuningForRandResponses



function slsimVoxTuningForRandResponses

%make random responses
d = slsimfMRIdatabase('random');  %--> validated !
...
parfor voxnum = 1:nVox
    ...
    %selectivity when switching to prior
    ...
    %selectivity when switching to motion direction
...
%are first. Then organize voxel plots 5 by 5 on different figures
%sorting
...
%loop over voxels and plot their direction tuning
for voxnum = 1:nVox   
    ...
    %plot 25 vox / figure
    %note: voxel selectivities when sw-to-prior/direction
