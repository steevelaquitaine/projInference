...
%slfmriGetVoxTuningNeuralVector.m
%
%
...
%       [o,prep,VoxelsParams,voxRawTunings] = slfmriGetVoxPopActivity('myRandomDir',{'mySwitch=1','mySwitch=2'},15,o,'loadVoxTuning','loadInstancesdb')
%
%       o = slfmriGetVoxTuningNeuralVector('myRandomDir',{'mySwitch=1','mySwitch=2'},'myRandomCoh=0.06',85,o,'useinputdb',d_dirBalbySw{coh_u==coherence},'getVoxTuning','vmfitr2cutoff=0');
%
%
%inputs:
...
function [o,prep,VoxelsParams,voxRawTunings] = slfmriGetVoxTuningNeuralVector(var0,var1,var2,thisvar0,o,varargin)
...
if any(strcmp(varargin,'getVoxTuning'))
    ...
    if ~isempty(var1{1})
        for voxnum = 1 : nVox
            fprintf('-')
            st1 = slfmrigetSingleVoxTuningNeuralVector(voxnum,var0,var1{1},var2,d);                        
    ...
    if ~isempty(var1{2})
        parfor  voxnum = 1 : nVox
            fprintf('-')
            st2 = slfmrigetSingleVoxTuningNeuralVector(voxnum,var0,var1{2},var2,d);
    ...
    %save raw parameters
    voxRawTunings.st1bkp = st1bkp;
    voxRawTunings.st2bkp = st2bkp;   
    save('voxRawTunings','voxRawTunings')    
