...
%choose "class" (what we decode)
          decodedClass = 'myRandomDir';

%choose ROI (where we decode)
             myROIname = 'allMT'; %or 'V1toMT';
           ROIFilePath = '/Users/steeve/fMRI_data/s02520140220/ROIs';
...
anatFileName = 's025_rightflat.hdr';
anatFilePath = '/Users/steeve/fMRI_data/s02520140220/Anatomy';
...
%motion onset
    startLag = 'startLag=2'; %include 2nd vols and blockLen-1 next vols   
    blockLen = 'blockLen=8'; %# of averaged vols
...
stimvol = getStimvol(getMLRView,decodedClass,'taskNum',taskNum,'phaseNum',phaseNum,'segmentNum',segmentNum);
...
%onset.
myROI = getInstances(getMLRView,myROI,stimvol,'n=inf',startLag,blockLen);
myROI = myROI{1};
...
startLags = {'startLag=1','startLag=2','startLag=3','startLag=4','startLag=5',...
    'startLag=6','startLag=7','startLag=8','startLag=2'};
blockLens = {'blockLen=2','blockLen=2','blockLen=2','blockLen=2','blockLen=2',...
    'blockLen=2','blockLen=2','blockLen=2','blockLen=8'};
tic
