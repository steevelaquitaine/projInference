...
%     usage: taskDotDir
%        by: justin gardner modified by Steeve Laquitaine 14/02/15
%      date: 14/02/15
...
task{2}{1}.randVars.myRandomDir=[ThrownDir params.task.parameter.dir.series(myTrialRand) params.task.parameter.dir.series(myTrialRand)];
task{2}{1}.randVars.myRandomCoh=[ThrownCoh params.task.parameter.dir.coh(myTrialRand) params.task.parameter.dir.coh(myTrialRand)];
...
%     
%     %if you want to you use keyborad button '1' to enter choice
...
if ~isfield(stimulus,'dots') || ~isfield(stimulus.dots,'rmax'), stimulus.dots.rmax=7.5;end%(radius in angle)
if ~isfield(stimulus.dots,'xcenter'), stimulus.dots.xcenter=0;end
if ~isfield(stimulus.dots,'ycenter'), stimulus.dots.ycenter=0;end
