%testExperiment.m
%
%       $Id: dotslocSL.m,v 1.6 2009/02/02 03:55:00 justin Exp $
%     usage: dotslocSL
%        by: justin gardner modified by steeve laquitaine
%      date: 09/07/06 modified 140210
% copyright: (c) 2006 Justin Gardner (GPL see mgl/COPYING)
%   purpose: localizer steeve experiment

function myscreen=dotslocSL(type)
...
%psychophysics
if ~isfield(stimulus,'dots') || ~isfield(stimulus.dots,'rmax'), stimulus.dots.rmax=7.5;end;
if ~isfield(stimulus.dots,'xcenter'), stimulus.dots.xcenter=0;,end
if ~isfield(stimulus.dots,'ycenter'), stimulus.dots.ycenter=0;,end
