...
% SLfmriProtocolanatRetino_sFantom201503XX.m
% 
%                  $Id: SLfmriProtocolanatRetino_sFantom201503XX.m 
...
%
%CCW wedges (4:9 min)
%we set: 10 cycles + half cycle , 24s/cycle , 17 vols/cycle + 8 vols, MUX2-ARC1 , 2.4 mm iso vox.res , 1.4s TR , 178 vols 
%mglSimulateRun(1.4,17*10+floor(17/2),5,'a');
gruRetinotopy('displayName=fMRIproj32','wedges=1','direction=1','numCycles=10','stimulusPeriod=24','stepsPerCycle',17,'doEyeCalib=-1','initialHalfCycle=1');

%CW wedges (178 vols alias "phases per location", 4:9 min)
gruRetinotopy('displayName=fMRIproj32','wedges=1','direction=-1','numCycles=10','stimulusPeriod=24','stepsPerCycle',17,'doEyeCalib=-1','initialHalfCycle=1');

%expanding rings (178 vols alias "phases per location", 4:9 min)
gruRetinotopy('displayName=fMRIproj32','rings=1','direction=1','numCycles=10','stimulusPeriod=24','stepsPerCycle',17,'doEyeCalib=-1','initialHalfCycle=1');
...
gruRetinotopy('displayName=fMRIproj32','bars=1','fixedRandom=1','stimulusPeriod=24','stepsPerCycle',17,'blanks=3','doEyeCalib=-1');
