...
%`    usage: 
%
%           mglSimulateRun(.5,80,0)
%           SLtaskDotDirfMRI05('fMRIproj16')
% 
%
%note: update libraries

function myscreen = SLtaskDotDirfMRI05(screenName)

%Load parameters
params = load('fMRIParamsPrior80Coh12and06');
fprintf('(SLtaskDotDirfMRI) Loading fMRI task parameters \n')
...
%When subject chose, get trial info (jump to segment 5 in updateScreenCallback)
