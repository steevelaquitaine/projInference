...
%    date: 140215 updated 150711
% purpose: draw circular histogram
%   usage: 
%
%       figure('color','w'); SLcircHist([5:10:355],round(vmPdfs([5:10:355],225,2.77,'norm')*1000),[1 0 0],5)
%       figure('color','w'); SLcircHist([5:10:355],round(vmPdfs([5:10:355],225,2.77,'norm')*1000),[1 0 0],40)
%
% varargin are:
%   - 'scaledRadius'
