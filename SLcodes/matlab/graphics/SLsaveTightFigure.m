...
% reference: http://tipstrickshowtos.blogspot.com/2010/08/how-to-get-rid-of-white-margin-in.html
%
%  usage: SAVETIGHTFIGURE(H,OUTFILENAME) 
%purpose: Saves figure H in file OUTFILENAME without
%   the white space around it. 


function SLsaveTightFigure(h,outfilename)
