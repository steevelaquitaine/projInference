...
%Description: List of simulations & modeling analyses
%
...
%% 131004 Simulation to calculate standard deviation of von Mises and 
%correspondence to gaussians
...
%% 131004 simulation of data to quantify the effect of prior strength 
%on behavior.
...
%% 131224. Compare a von mises density with a Gaussian density in case 
%of our priors
vonMisesVsGaussian


%% 140113. simulate prediction data from Girshick Bayesian inference with 
%cardinal prior (mixture of 4 von mises with strength kpc).
tic
%matlabpool 12
initCardinals
[pred,Kinput,Kreal,disp,coh,pstd] = simCardinal(data,disp,coh,pstd,k,'TrueMean',5);
toc

%% 140114 draw Bayesian inference with flat tails von mises prior and llhs
%Bayes with flat tail prior and llh seems to make similar predictions as
%heuristic model.GirshickPredictionsWithBimodalPrior
BayesWithflatTailVonMisesPrior


%% 140122 Range of estimate predictions of Girshick estimator.
%To see the MAP estimates' densities predicted by girshick estimator model 
%with cardinal prior. "uniqMAP" gives an idea of the resolution of the
%estimates we can get by changing motion direction resolution.
[mPdfs,l,pr,po,di,m,uniqMAP] = GirshickPredictionsWithCardinalPrior;


%% 140205 draw estimate predictions of Girshick estimator with 
%"Cardinal prior" and "learnt prior".
%I should draw those predictions on polar density plots....
[mPdfs,l,pr,po,di,m,uniqMAP] = GirshickPredictionsWithlearntAndCardinalPrior;


%% 140205. simulate prediction data from Girshick Bayesian inference with 
%Cardinal and learnt prior. 
tic
%matlabpool 12
initBayesWithlearntAndCardinalPrior
[pred,Kinput,Kreal,disp,coh,pstd] = simBayesWithlearntAndCardinalPrior(data,disp,coh,pstd,k,'TrueMean',5);
toc

%%
SLProveHowToConstrainLLHandPrior
