...
if isempty(fitP)==1
    ...
    sl1_0=1:500:1000; %before(1:81:164)
    sl2_0=1:500:1000;
    sl3_0=1:500:1000;
    sp1_0=1:500:1000;
    sp2_0=1:500:1000;
...
%     sl1_0=1:81:164; %before(1:81:164)
%     sl2_0=1:81:164;
%     sl3_0=1:81:164;
%     sp1_0=1:81:164;
%     sp2_0=1:81:164;
                        ...
                        for n=1:numel(sp3_0)
                            for e=1:numel(sp4_0)
                                for f=1:numel(sM_0)
                                    ...
                                    %Fit
                                    %model 5 can make prediction within the
                                    %full range [0 1000] thanks to the
...
%             'displayname',strcat(F.g2.nm,':',num2str(F.g2.L(j))));       
        ...
        %.........................
        %mean
        p13a=plot(F.g3.L,pred.mean(:,k,j),'-',... %groups 3 forms x-axis
            'color',F.g2.color{j} - [0.2 0 0],...
            'linewidth',2,...
            'displayname',strcat(F.g2.nm,':',num2str(F.g2.L(j))));
...
%             'displayname',strcat(F.g2.nm,':',num2str(F.g2.L(j))));
        ...
        scatter(fig1.dataInfog3{j,k},fig1.datastd{j,k},...
            'MarkerEdgeColor','w',...
            'MarkerFaceColor',F.g2.color{j},...
            'displayname',strcat(F.g2.nm,':',num2str(F.g2.L(j))))
        ...
        %............................
        %mean
        p13a=plot(F.g3.L,pred.std(:,k,j)','-',... %groups 3 forms x-axis
            'color',F.g2.color{j} - [0.2 0 0],...
            'linewidth',2,...
            'displayname',strcat(F.g2.nm,':',num2str(F.g2.L(j))));
    end
