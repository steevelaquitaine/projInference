...
%Models
function [Sp,pred,fitP,R2,udata,sdata,dataOut,predOut,Fbp,F,stdPa,fitPt,logl]=modelBayesInfSanityCheckRandKm(data,Fs,fig,FofLl2del,Ll2del)
pred=[];
fitP=[];
R2=[];
udata=[];
...
if isempty(fitP)==1
    ...
    sl1_0=17;%[250 350 450];%350;%k(1);
    sl2_0=2.1;%[14 24 34];%24;%k(2);
    sl3_0=2;%[1.5 7.5 17.5];%7.5;%k(3);
    sp1_0=2.25;%[1.3 4.3 14.3];%4.3;%k(4);
    sp2_0=2.9;%[1.9 8.9 18.9];%8.9;%k(5);
    sp3_0=8.9;%[4.5 14.5 24.5];%14.5;%k(6);
    sp4_0=43;%[23 33 43];%33;%k(7);
    Pm=0.02;
...
%probability (also maxlikelihood of trial's data).
mi=ul;
