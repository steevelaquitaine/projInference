...
%SLsimulateBayesWithBernoulliPrior_TailedLLH(10000,0.0001,0.65,[45 135])

function SLsimulateBayesWithBernoulliPrior_TailedLLH(kl,tailL,pMax,pDir)
...
for i = 1 : length(evidence)
    ...
    if i==1;
        ...
        legend('boxoff')
        title('Bayesian estimation with Bernoulli(/tailed) prior(/LLH)')
    end
end
