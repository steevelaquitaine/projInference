...
%     usage: simBayesInferenceVsCompetition([225 215 195 70],[2.2 2.2 2.2 2.2],[145 305],[11.6 11.6])
%     usage: simBayesInferenceVsCompetition([225 215 195 70],[2.2 2.2 2.2 2.2],[205 245],[11.6 11.6])

function post=simBayesInferenceVsCompetition(llhmean,llhstd,priormode,priorstd)
...
%bimodal Gaussian prior
tmp=vmPdfs(1:1:360,priormode,priorstd,'norm');
Prior=0.5*(tmp(:,1)+tmp(:,2));
