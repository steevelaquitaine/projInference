...
%SLsimulateAdaptedPrior.m
%
% author: steeve laquitaine
%   date: 141122
%purpose: simulate Bayesian posterior in an example trial when prior is a
%         von Mises with an adapted fat tail (mixture of von Mises and 
%         uniform)
%
%usage:
%       SLsimulateAdaptedPrior(0.95,1,600)
%
%Predictions:


function SLsimulateAdaptedPrior(weightTail,kl,kp)
