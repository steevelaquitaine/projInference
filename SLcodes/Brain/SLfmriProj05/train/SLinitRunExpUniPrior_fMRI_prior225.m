...
%SLinitRunExpUniPrior_fMRI_prior225.m 
%
%
%author: Steeve
%  date: 160423
%purpose: initialize parameters for training motion direction estimation task
%         with prior over motion direction with mean 225 deg and std 80 deg
%
% usage:
%
%        task = SLinitRunExpUniPrior_fMRI_prior225('TRAINparamsPriors80m225Coh12and06',225,0.74848,[.06 .12],[91 37],15:70:355,[0.5 0 0])
%
% INPUT
%     mean
%     variance
...
%a run
function task = SLinitRunExpUniPrior_fMRI_prior225(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
