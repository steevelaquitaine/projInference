...
% task = SLinitRunExpUniPriorTrain('trainParamsPrior80Coh12and06',225,0.74848,[.06 .12],[150 74],5:10:355,[0.5 0 0])

%a run
function task = SLinitRunExpUniPriorTrain(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
...
for i = 1 : nCoh
    ...
    ylim([0 maxp])
    set(gca,'xtick',task.parameter.dir.sample.degree(1:2:end),'xticklabel',task.parameter.dir.sample.degree(1:2:end))
