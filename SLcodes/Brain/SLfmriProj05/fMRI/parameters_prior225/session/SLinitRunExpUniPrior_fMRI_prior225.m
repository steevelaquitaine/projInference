...
%SLinitRunExpUniPrior_fMRI.m 
%author: Steeve
%  date: 160423
% usage:
%        task = SLinitRunExpUniPriorfMRI('fMRIparamsPriors80m225Coh12and06',225,0.74848,[.06 .12],[91 37],15:70:355,[0.5 0 0])
%
% INPUT
%     mean
%     variance
...
%a run
function task = SLinitRunExpUniPrior_fMRI(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
