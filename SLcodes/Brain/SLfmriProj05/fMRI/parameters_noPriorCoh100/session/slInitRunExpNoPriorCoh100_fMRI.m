...
%slInitRunExpNoPriorCoh100_fMRI.m 
%
%
% author: Steeve
%   date: 160423
%purpose: create parameters for fMRI session with no prior (uniform distribution) over
%         motion direction
% usage:
%
%        task = slInitRunExpNoPriorCoh100_fMRI('fMRIparamsNoPriorCoh100',225,0,1,127,15:70:355,[0.5 0 0])
%
% INPUT
%     mean
%     variance
...
%a run
function task = slInitRunExpNoPriorCoh100_fMRI(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
