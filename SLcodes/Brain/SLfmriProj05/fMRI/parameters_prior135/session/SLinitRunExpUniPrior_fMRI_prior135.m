...
%SLinitRunExpUniPrior_fMRI_prior135.m 
%
%
% author: Steeve
%   date: 160423
%purpose: create parameters for fMRI session with prior distribution over
%         motion direction with mean 135 deg and std 80 deg.
% usage:
%
%        task = SLinitRunExpUniPrior_fMRI_prior135('fMRIparamsPriors80m135Coh12and06',135,0.74848,[.06 .12],[91 37],65:70:355,[0.5 0 0])
%
% INPUT
%     mean
%     variance
...
% 
%note:  0.74848 (std = 80 degrees)  


%a run
function task = SLinitRunExpUniPrior_fMRI_prior135(Prname,Prmean,Prstd,coh,Prnumtrials_perCoh,PrSp,colorH)
